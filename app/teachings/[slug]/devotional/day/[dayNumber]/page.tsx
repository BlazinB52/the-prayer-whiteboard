...
export default async function DevotionalDayPage({ params }: { params: Promise<{ slug: string; dayNumber: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[#f7f2e8] text-[#243126]">
      <PublicHeader maxWidthClassName="max-w-3xl" end={<Link href={`/teachings/${slug}/devotional`} className="shrink-0 text-sm font-extrabold text-[#244a3a]">Devotional overview</Link>} />
