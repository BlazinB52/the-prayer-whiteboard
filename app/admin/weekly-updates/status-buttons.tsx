...
type Action = (state: WeeklyUpdateActionState) => Promise<WeeklyUpdateActionState>;

export function WeeklyUpdateStatusButton({ action, label, variant = "primary" }: { action: Action; label: string; variant?: "primary" | "danger" }) {
