-- Teachings may be published and featured without an assigned chalkboard.
-- Homepage chalkboards are supplied by the current Weekly Update first, with
-- teaching chalkboards remaining optional display content.
