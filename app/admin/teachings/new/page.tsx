  ...
  return (
    <main className="admin-shell">
      <div className="mx-auto max-w-3xl">
        ...
        <TeachingForm action={createTeaching} values={{ title: "", teachingType: "standard", gatheringDate: "", centralTheme: "", introduction: "", summary: "", teaser1Heading: "", teaser1Text: "", teaser2Heading: "", teaser2Text: "", chalkboardAssetIds: [], includeFooter: false, footerId: "" }} chalkboards={chalkboardOptions} footers={footerOptions} />
      </div>
    </main>
  );
}
