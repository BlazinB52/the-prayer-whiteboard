...
function FeaturedHomepage({ data }: { data: FeaturedHomepageData }) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f2e8] text-[#243126]">
      ...
      <section id="latest" className="bg-[#244a3a] px-5 py-14 text-white sm:px-8 sm:py-20"><div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start"><div><p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#f0cb83]">{date}</p><h2 className="mt-4 text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl">{data.teaching.title}</h2><p className="mt-5 text-base leading-7 text-[#dce8e1]">{description}</p><Link href={teachingPath} className="mt-7 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-[#f1c66f] px-5 font-extrabold text-[#244a3a]">Read the full teaching <ArrowRight aria-hidden="true" size={18} /></Link><ul className="mt-5 space-y-2 text-sm font-bold text-[#dce8e1]"><li className="flex max-w-md items-center justify-between gap-3"><span>7-Day Devotional</span><span className="text-xs font-extrabold uppercase tracking-wide text-[#f0cb83]">Coming Soon</span></li><li className="flex max-w-md items-center justify-between gap-3"><span>Chalkboard</span><span className="text-xs font-extrabold uppercase tracking-wide text-[#f0cb83]">Coming Soon</span></li><li className="flex max-w-md items-center justify-between gap-3"><span>Shareable Teaching Guide</span><span className="text-xs font-extrabold uppercase tracking-wide text-[#f0cb83]">Coming Soon</span></li></ul></div><div className="grid gap-4 sm:grid-cols-2">{data.highlights.map((highlight, index) => <HomepageHighlightCard key={highlight.id} highlight={highlight} href={`${teachingPath}#section-${highlight.id}`} index={index} />)}</div></div></section>
      ...
      <section id="latest" className="bg-[#244a3a] px-5 py-14 text-white sm:px-8 sm:py-20">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
          <div>
            ...
            <ul className="mt-5 max-w-md space-y-2 text-sm font-bold text-[#dce8e1]">
              <li className="flex items-center justify-between gap-3">
                <span>7-Day Devotional</span>
                <span className="text-xs font-extrabold uppercase tracking-wide text-[#f0cb83]">Coming Soon</span>
              </li>
              <li className="flex items-center justify-between gap-3">
